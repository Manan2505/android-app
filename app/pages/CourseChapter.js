    ...
    <View style={{padding:20,paddingTop:50,height:'100%'}}>
        ...
        <FlatList data={chapter} horizontal={true} pagingEnabled ref={(ref)=>{
            ...
            <View style={{width:Dimensions.get('screen').width*0.85,height:'100%',marginRight:15,padding:10}}>
                ...
                <TouchableOpacity onPress={()=>setRun(true)} style={{backgroundColor:Colors.gray,padding:5,borderRadius:5,marginTop:10,display:'flex',flexDirection:'row'}}>
                    <Ionicons name='play-circle' size={20} color={Colors.white}/>
                    <Text style={{textAlign:'center',marginLeft:5,marginBottom:40}}>Run</Text>
                </TouchableOpacity>
                </View>:null}
